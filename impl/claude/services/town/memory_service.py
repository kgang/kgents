...
Migrated from agents/town/persistent_memory.py to services/ per Metaphysical
Fullstack pattern (AD-009). Business logic separated from categorical primitives.

This module provides:
- PersistentCitizenMemory: D-gent backed memory for individual citizens
- TownCollectiveMemory: Shared town-wide event memory
- ConversationEntry: Dialogue history with emotional context

AGENTESE aspects:
- self.memory.citizen.<id>.recall - Recall citizen memories
- self.memory.citizen.<id>.store - Store episodic memory
- world.town.collective.witness - View town events
