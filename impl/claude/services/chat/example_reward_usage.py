...
def main() -> None:
    ...
    print(f"Response: {result.response}")
    print(f"Tools: {len(result.tools)}")
    print(f"Mutations: Yes (acknowledged)")
    print()
    print("Scores:")
    print(f"  Tasteful:      {score.tasteful:.2f}")
    print(f"  Curated:       {score.curated:.2f}")
    ...
    print(f"Response: {result.response}")
    print(f"Tools: {len(result.tools)}")
    print(f"Mutations: Yes (unacknowledged)")
    print()
    print("Scores:")
    print(f"  Tasteful:      {score.tasteful:.2f}")
    print(f"  Curated:       {score.curated:.2f}")
    ...
    print(f"  ETHICAL: 3.0 (default: 2.0)")
    print(f"  COMPOSABLE: 2.0 (default: 1.5)")
    print(f"  JOY_INDUCING: 0.5 (default: 1.2)")
    print()
