"""
PreferencesService: Business logic for PreferencesAgent.

Agent for: Build a preferences manager
...
from .polynomial import PreferencesAgentPolynomial, PreferencesAgentState


class PreferencesService:
    """
    Service implementation for PreferencesAgent.
    ...
    def __init__(self) -> None:
        ...
        self._polynomial = PreferencesAgentPolynomial()

    @property
    def state(self) -> PreferencesAgentState:
        """Current state."""
