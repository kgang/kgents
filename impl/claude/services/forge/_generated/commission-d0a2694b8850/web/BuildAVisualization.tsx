/**
 * BuildAVisualization - Agent for: Build a chat interface
 *
...
export function BuildAVisualization({
  ...
  const description = manifest.data?.description || initialStatus?.description || 'Agent for: Build a chat interface';
