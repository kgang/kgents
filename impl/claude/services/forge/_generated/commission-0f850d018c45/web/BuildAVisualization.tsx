/**
 * BuildAVisualization - Agent for: Build a note-taking app
 *
...
export function BuildAVisualization({
  ...
  const description = manifest.data?.description || initialStatus?.description || 'Agent for: Build a note-taking app';
