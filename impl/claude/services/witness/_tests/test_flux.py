...
class TestGitFluxState:
    ...
    def test_states_exist(self) -> None:
        ...
        from services.witness.watchers.git_flux import GitFluxState
...
class TestGitWatcherFluxLifecycle:
    ...
    def test_initial_state_is_dormant(self) -> None:
        ...
        from services.witness.watchers.git_flux import GitFluxState, GitWatcherFlux
...
class TestGitWatcherFluxStreaming:
    ...
    async def test_yields_events_from_watcher(self) -> None:
        ...
        from services.witness.watchers.git_flux import GitWatcherFlux
...
class TestCreateGitWatcherFlux:
    ...
    def test_factory_creates_flux(self) -> None:
        ...
        from services.witness.watchers.git_flux import (
            GitFluxState,
            GitWatcherFlux,
