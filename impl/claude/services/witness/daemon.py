...
def create_watcher(watcher_type: str, config: DaemonConfig) -> BaseWatcher[Any] | None:
    ...
    if watcher_type == "git":
        ...
        from services.witness.watchers.filesystem import create_filesystem_watcher
        ...
        from services.witness.watchers.test_watcher import create_test_watcher

        return create_test_watcher()

    elif watcher_type == "agentese":
        from services.witness.watchers.agentese import create_agentese_watcher

        return create_agentese_watcher()

    elif watcher_type == "ci":
        from services.witness.watchers.ci import create_ci_watcher
