/**
 * Tests for MesaV2: Props-based Mesa canvas.
 *
 * MesaV2 receives citizens as props instead of reading from Zustand store.
 */
...
vi.mock('@pixi/react', () => ({
  ...
  Container: ({ children }: { children: React.ReactNode }) => <div data-testid="pixi-container">{children}</div>,
