/**
 * Tests for CitizenPanelV2: Props-based citizen detail panel.
 *
 * CitizenPanelV2 receives citizen from props instead of reading from Zustand.
 */
