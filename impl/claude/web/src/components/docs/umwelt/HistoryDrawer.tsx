  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        <span className="text-sm font-medium capitalize" style={{ color: fromColor }}>
          {entry.from.archetype}
        </span>
        <ArrowRight className="w-3 h-3 text-gray-500" />
        <span className="text-sm font-medium capitalize" style={{ color: toColor }}>
          {entry.to.archetype}
        </span>
        {isLatest && <span className="ml-auto text-xs text-cyan-400">(latest)</span>}
      </div>
