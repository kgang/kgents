 ...
 */
export function useCreateHost(): MutationResult<
  WorldParkHostCreateResponse,
  WorldParkHostCreateRequest
> {
  ...
  const mutateAsync = useCallback(
    async (data: WorldParkHostCreateRequest) => {
      setIsPending(true);
      try {
        const result = await execute(
          fetchAgentese<WorldParkHostCreateResponse>('world.park.host.create', data)
        );
  ...
  const mutate = useCallback(
    (data: WorldParkHostCreateRequest) => {
 ...
 */
export function useUpdateHost(): MutationResult<
  WorldParkHostUpdateResponse,
  WorldParkHostUpdateRequest
> {
  ...
  const mutateAsync = useCallback(
    async (data: WorldParkHostUpdateRequest) => {
      setIsPending(true);
      try {
        const result = await execute(
          fetchAgentese<WorldParkHostUpdateResponse>('world.park.host.update', data)
        );
  ...
  const mutate = useCallback(
    (data: WorldParkHostUpdateRequest) => {
      mutateAsync(data).catch(() => {});
    },
    [mutateAsync]
  );
 ...
 */
export function useInteractWithHost(): MutationResult<
  WorldParkHostInteractResponse,
  WorldParkHostInteractRequest
> {
  ...
  const mutateAsync = useCallback(
    async (data: WorldParkHostInteractRequest) => {
      setIsPending(true);
      try {
        const result = await execute(
          fetchAgentese<WorldParkHostInteractResponse>('world.park.host.interact', data)
        );
  ...
  const mutate = useCallback(
    (data: WorldParkHostInteractRequest) => {
      mutateAsync(data).catch(() => {});
    },
    [mutateAsync]
  );
 ...
 */
export function useStartEpisode(): MutationResult<
  WorldParkEpisodeStartResponse,
  WorldParkEpisodeStartRequest
> {
  ...
  const mutateAsync = useCallback(
    async (data: WorldParkEpisodeStartRequest = {}) => {
      setIsPending(true);
      try {
        const result = await execute(
          fetchAgentese<WorldParkEpisodeStartResponse>('world.park.episode.start', data)
        );
  ...
  const mutate = useCallback(
    (data: WorldParkEpisodeStartRequest = {}) => {
      mutateAsync(data).catch(() => {});
    },
    [mutateAsync]
  );
 ...
 */
export function useEndEpisode(): MutationResult<
  WorldParkEpisodeEndResponse,
  WorldParkEpisodeEndRequest
> {
  ...
  const mutateAsync = useCallback(
    async (data: WorldParkEpisodeEndRequest) => {
      setIsPending(true);
      try {
        const result = await execute(
          fetchAgentese<WorldParkEpisodeEndResponse>('world.park.episode.end', data)
        );
  ...
  const mutate = useCallback(
    (data: WorldParkEpisodeEndRequest) => {
      mutateAsync(data).catch(() => {});
    },
    [mutateAsync]
  );
 ...
 */
export function useCreateLocation(): MutationResult<
  WorldParkLocationCreateResponse,
  WorldParkLocationCreateRequest
> {
  ...
  const mutateAsync = useCallback(
    async (data: WorldParkLocationCreateRequest) => {
      setIsPending(true);
      try {
        const result = await execute(
          fetchAgentese<WorldParkLocationCreateResponse>('world.park.location.create', data)
        );
  ...
  const mutate = useCallback(
    (data: WorldParkLocationCreateRequest) => {
      mutateAsync(data).catch(() => {});
    },
    [mutateAsync]
  );
