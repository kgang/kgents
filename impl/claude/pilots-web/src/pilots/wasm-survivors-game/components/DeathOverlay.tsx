...
// DD-21: Attack types for specific death attribution
export type AttackType = 'lunge' | 'charge' | 'stomp' | 'projectile' | 'combo' | 'contact';
...
const ENEMY_NAMES: Record<EnemyType, string> = {
  ...
  tank: 'BRUTE',
  boss: 'BOSS',
  spitter: 'SNIPER',  // DD-24
  colossal_tide: 'THE TIDE',  // DD-030-4
};
...
const ENEMY_DESCRIPTIONS: Record<EnemyType, string> = {
  ...
  spitter: 'Shot from afar',  // DD-24
  colossal_tide: 'Consumed by the hive',  // DD-030-4
};

// DD-21: Attack type names for specific death attribution
...
const ATTACK_DESCRIPTIONS: Record<AttackType, string> = {
  lunge: 'Caught by a quick lunge',
  charge: 'Run down by a charge',
  stomp: 'Crushed by a ground pound',
  projectile: 'Hit by a ranged shot',
  combo: 'Overwhelmed by a combo attack',
  contact: 'Touched by the enemy',
};
...
export function DeathOverlay({ death, onPlayAgain, onViewCrystal }: DeathOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      >
        {/* Main death text - DD-21: Use attack-specific text when available */}
        <div
