...
class TestIncrementalParserComplete:
    ...
    def test_parse_complete_object(self) -> None:
    ...
    def test_parse_complete_array(self) -> None:
        parser = IncrementalParser()
        text = "[1, 2, 3, 4, 5]"
...
class TestIncrementalParserPartial:
    ...
    def test_parse_unclosed_object(self) -> None:
        parser = IncrementalParser()
        text = '{"name": "Alice", "age": 30'
    ...
    def test_parse_incomplete_string(self) -> None:
        parser = IncrementalParser()
        text = '{"name": "Ali'
...
class TestIncrementalParserStream:
    ...
    def test_stream_complete_object(self) -> None:
        parser = IncrementalParser()
    ...
    def test_stream_progressive_confidence(self) -> None:
        parser = IncrementalParser()
        tokens = ["[1", ", 2", ", 3]"]
    ...
    def test_stream_metadata_tracking(self) -> None:
        parser = IncrementalParser()
        tokens = ['{"a":', " 1, ", '"b": 2}']
...
class TestIncrementalParserConfidence:
    ...
    def test_complete_has_max_confidence(self) -> None:
        parser = IncrementalParser()
        result = parser.parse('{"complete": true}')

        assert result.confidence == 1.0

    def test_incomplete_has_reduced_confidence(self) -> None:
        parser = IncrementalParser()
...
class TestIncrementalParserMetadata:
    ...
    def test_node_count_metadata(self) -> None:
        parser = IncrementalParser()
    ...
    def test_incomplete_nodes_metadata(self) -> None:
        parser = IncrementalParser()
        result = parser.parse('{"incomplete": ')
    ...
    def test_parse_error_metadata(self) -> None:
        parser = IncrementalParser()
...
class TestIncrementalParserRepairs:
    ...
    def test_partial_parse_has_repairs(self) -> None:
        parser = IncrementalParser()
        result = parser.parse('{"incomplete": ')
    ...
    def test_complete_parse_no_repairs(self) -> None:
        parser = IncrementalParser()
        result = parser.parse('{"complete": true}')
