...
class TestParseResult:
    ...
    def test_success_requires_value(self):
    ...
    def test_success_requires_positive_confidence(self):
    ...
    def test_partial_requires_low_confidence(self):
...
class TestParserConfig:
    ...
    def test_stream_chunk_size_positive(self):
    ...
    def test_max_reflection_retries_non_negative(self):
...
class TestIdentityParser:
    ...
    def test_identity_configure(self):
    ...
    def test_identity_configure_validation(self):
