...
class TestPersistentRegistryCreation:
    ...
    @pytest.mark.asyncio
    async def test_create_new_registry(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_loads_existing(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_with_custom_config(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_fails_if_missing_and_not_allowed(
        self, temp_dir: Path
    ) -> None:
...
class TestPersistentRegistryOperations:
    ...
    @pytest.mark.asyncio
    async def test_register_auto_saves(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_register_manual_save(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_persists(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_usage_persists(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_deprecate_persists(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_add_relationship_persists(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
...
class TestPersistentRegistryReload:
    ...
    @pytest.mark.asyncio
    async def test_reload_discards_changes(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
...
class TestCatalogHistory:
    ...
    @pytest.mark.asyncio
    async def test_history_tracks_changes(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
...
class TestTonguePersistence:
    ...
    async def test_tongue_metadata_persists(
        self, temp_dir: Path, sample_tongue_entry: CatalogEntry
    ) -> None:
...
class TestConvenienceFunctions:
    ...
    @pytest.mark.asyncio
    async def test_create_persistent_registry(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_load_or_create_registry_new(self, temp_dir: Path) -> None:
...
class TestEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_concurrent_registrations(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_unicode_content(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_empty_fields(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_close_saves_on_exit(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
...
class TestDGentIntegration:
    ...
    @pytest.mark.asyncio
    async def test_history_file_created(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_parent_directory_created(
        self, temp_dir: Path, sample_entry: CatalogEntry
    ) -> None:
