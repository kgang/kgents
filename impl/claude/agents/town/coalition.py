"""
Coalition Detection and Reputation System for Agent Town.
...
class Coalition:
    ...
    _centroid: Eigenvectors | None = field(default=None, repr=False)
...
class CoalitionManager:
    """
    Manages coalition lifecycle and reputation.
    ...
    def detect(self) -> list[Coalition]:
    ...
    def compute_reputation(self, alpha: float = 0.5) -> dict[str, float]:
        """Compute global reputation scores."""
        return self._reputation.compute_reputation(self._citizens, alpha)
