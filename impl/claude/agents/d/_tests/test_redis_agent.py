...
class TestRedisTTL:
    ...
    @pytest.mark.asyncio
    async def test_ttl_agent_creation(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_ttl(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_ttl_no_ttl_configured(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_ttl_nonexistent_key(self) -> None:
...
class TestFactoryFunctions:
    ...
    def test_create_redis_agent(self) -> None:
    ...
    def test_create_valkey_agent(self) -> None:
    ...
    def test_history_key_format(self) -> None:
...
class TestRedisAgentSerialization:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skipif(not FAKEREDIS_AVAILABLE, reason="fakeredis not installed")
    async def test_primitive_dict(self) -> None:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skipif(not FAKEREDIS_AVAILABLE, reason="fakeredis not installed")
    async def test_primitive_list(self) -> None:
