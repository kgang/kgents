...
class TestDreamReportRendering:
    ...
    def test_render_report_has_box(self):
    ...
    def test_render_report_shows_phase(self):
    ...
    def test_render_interrupted_report(self):
    ...
    def test_render_report_shows_progress(self):
...
class TestDreamReportCompact:
    ...
    def test_compact_shows_status(self):
    ...
    def test_compact_from_dict(self):
...
class TestMorningBriefing:
    ...
    def test_briefing_with_questions(self):
    ...
    def test_briefing_has_box(self):
    ...
    def test_briefing_shows_questions(self):
    ...
    def test_briefing_from_dicts(self):
...
class TestBriefingQuestion:
    ...
    def test_render_high_priority(self):
...
class TestMigrationProposals:
    ...
    def test_render_proposals(self):
    ...
    def test_render_from_dicts(self):
        """Test from dict list."""
        proposals = [
            {
                "proposal_id": "p-001",
...
class TestFactoryFunctions:
    ...
    def test_create_mock_dream_report(self):
    ...
    def test_create_mock_dream_report_interrupted(self):
    ...
    def test_create_mock_dream_report_custom_chunks(self):
    ...
    def test_create_mock_questions_limited(self):
