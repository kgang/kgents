...
class Version:
    ...
    def parse(version_string: str) -> "Version":
        ...
        if not match:
            raise ValueError(
                f"Invalid version string: '{version_string}'. Expected format: 'MAJOR.MINOR.PATCH'"
            )
...
class Artifact:
    ...
    def to_markdown(self) -> str:
        ...
        sections.append("")
        sections.append("> *This section contains the original natural language intent.*")
        ...
        sections.append("")
        sections.append("> *This section defines the agent's interface and guarantees.*")
        ...
        sections.append("")
        sections.append("> *This section contains test cases that validate correct behavior.*")
        ...
        sections.append(">")
        sections.append("> This code is synthesized by F-gent from the Intent and Contract.")
        sections.append(
...
def extract_tags_from_intent(intent: Intent) -> list[str]:
    ...
    tags.update(word for word in purpose_words if word not in stop_words and len(word) > 3)
...
def determine_version_bump(old_contract: Optional[Contract], new_contract: Contract) -> VersionBump:
    """
