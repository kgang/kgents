...
class TestRealityGate:
    ...
    def test_admits_deterministic(self):
    ...
    def test_admits_probabilistic_by_default(self):
    ...
    def test_require_deterministic_mode(self):
    ...
    def test_check_output_for_chaotic_patterns(self):
    ...
    def test_entropy_budget_affects_classification(self):
...
class TestDeterministicOnly:
    ...
    def test_admits_atomic_intents(self):
    ...
    def test_rejects_complex_intents(self):
    ...
    def test_rejects_chaotic_intents(self):
    ...
    def test_check_output_determinism(self):
...
class TestBoundedComplexity:
    ...
    def test_admits_simple_intents(self):
    ...
    def test_rejects_long_intents(self):
...
class TestEntropyAware:
    ...
    def test_high_budget_admits_probabilistic(self):
    ...
    def test_low_budget_rejects_probabilistic(self):
    ...
    def test_very_low_budget_rejects_all(self):
    ...
    def test_always_rejects_chaotic(self):
    ...
    def test_with_budget_creates_new(self):
...
class TestCompositeContracts:
    ...
    def test_create_safe_gate(self):
...
class TestConvenienceFunctions:
    ...
    def test_admits_intent_all_pass(self):
    ...
    def test_admits_intent_any_fail(self):
    ...
    def test_gate_intent_admitted(self):
    ...
    def test_gate_intent_rejected(self):
    ...
    def test_gate_intent_custom_contracts(self):
...
class TestIntegration:
    ...
    def test_entropy_degradation(self):
    ...
    def test_strict_gate_very_restrictive(self):
