...
class TestContractDataclasses:
    ...
    def test_composition_rule_creation(self) -> None:
...
class TestTypeSynthesis:
    ...
    def test_infer_rest_api_types(self) -> None:
    ...
    def test_infer_file_system_types(self) -> None:
    ...
    def test_infer_summarization_types(self) -> None:
    ...
    def test_infer_json_output_type(self) -> None:
    ...
    def test_infer_list_output_type(self) -> None:
    ...
    def test_infer_boolean_output_type(self) -> None:
...
class TestInvariantExtraction:
    ...
    def test_extract_idempotent_invariant(self) -> None:
    ...
    def test_extract_pure_invariant(self) -> None:
    ...
    def test_extract_concise_invariant(self) -> None:
    ...
    def test_extract_no_hallucination_invariant(self) -> None:
    ...
    def test_extract_constraint_invariants(self) -> None:
    ...
    def test_extract_categorical_invariants(self) -> None:
...
class TestCompositionAnalysis:
    ...
    def test_sequential_composition_single_dependency(self) -> None:
    ...
    def test_parallel_composition_multiple_dependencies(self) -> None:
    ...
    def test_fan_out_composition(self) -> None:
...
class TestRealWorldExamples:
    ...
    def test_pipeline_agent(self) -> None:
    ...
    def test_idempotent_normalizer(self) -> None:
    ...
    def test_parallel_aggregator(self) -> None:
...
class TestContractMetadata:
    ...
    def test_semantic_intent_from_purpose(self) -> None:
    ...
    def test_agent_name_parameter(self) -> None:
...
class TestEdgeCases:
    ...
    def test_ambiguous_types(self) -> None:
    ...
    def test_multiple_composition_modes(self) -> None:
...
class TestIntegrationWithPhase1:
    ...
    def test_ambiguities_preserved(self) -> None:
