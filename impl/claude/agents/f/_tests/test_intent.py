...
class TestPurposeExtraction:
    ...
    def test_remove_agent_prefix(self):
...
class TestConstraintExtraction:
    ...
    def test_concise_constraint(self):
    ...
    def test_objective_constraint(self):
...
class TestAmbiguityDetection:
    ...
    def test_missing_performance_spec(self):
    ...
    def test_no_ambiguities_when_complete(self):
...
class TestRealWorldExamples:
    ...
    def test_complex_pipeline_agent(self):
...
class TestIntentMetadata:
    ...
    def test_examples_empty_by_default(self):
