...
class TestSchemaParser:
    ...
    def test_parse_simple_mcp_schema(self) -> None:
    ...
    def test_parse_schema_with_titled_types(self) -> None:
    ...
    def test_parse_schema_with_primitive_types(self) -> None:
    ...
    def test_parse_schema_missing_name(self) -> None:
    ...
    def test_schema_parser_preserves_original(self) -> None:
...
class TestInputParser:
    ...
    def test_parse_input_with_anchors(self) -> None:
    ...
    def test_parse_input_single_param(self) -> None:
...
class TestOutputParser:
    ...
    def test_parse_nested_json_output(self) -> None:
...
class TestErrorParser:
    ...
    def test_parse_auth_error(self) -> None:
    ...
    def test_parse_structured_error(self) -> None:
    ...
    def test_parse_400_bad_request(self) -> None:
    ...
    def test_parse_network_error(self) -> None:
...
class TestStreamingSupport:
    ...
    def test_schema_parser_stream(self) -> None:
    ...
    def test_input_parser_stream(self) -> None:
    ...
    def test_output_parser_stream(self) -> None:
    ...
    def test_error_parser_stream(self) -> None:
...
class TestParserConfiguration:
    ...
    def test_schema_parser_configure(self) -> None:
    ...
    def test_input_parser_configure(self) -> None:
    ...
    def test_output_parser_configure(self) -> None:
    ...
    def test_error_parser_configure(self) -> None:
...
class TestRealWorldToolScenarios:
    ...
    def test_web_search_tool_workflow(self) -> None:
    ...
    def test_api_call_error_handling(self) -> None:
