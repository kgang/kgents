...
class TestCollectTargets:
    ...
    def test_all_scope(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestCmdWipe:
    ...
    def test_missing_scope(self, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_invalid_scope(self, capsys: pytest.CaptureFixture[str]) -> None:
