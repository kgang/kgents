...
class TestGetGlobalPath:
    ...
    def test_custom_xdg_data_home(self, monkeypatch, tmp_path):
...
class TestCollectTargets:
    ...
    def test_all_scope(self, tmp_path, monkeypatch):
...
class TestCmdWipe:
    ...
    def test_dry_run_global(self, tmp_path, monkeypatch, capsys):
    ...
    def test_nothing_to_wipe(self, tmp_path, monkeypatch, capsys):
    ...
    def test_confirmation_required_without_force(self, tmp_path, monkeypatch, capsys):
    ...
    def test_confirmation_accepted(self, tmp_path, monkeypatch, capsys):
