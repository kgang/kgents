...
class TestExposeDecorator:
    ...
    def test_expose_attaches_metadata(self):
    ...
    def test_expose_with_help_only(self):
    ...
    def test_expose_with_examples(self):
    ...
    def test_expose_with_aliases(self):
    ...
    def test_expose_with_hidden(self):
    ...
    def test_expose_preserves_function(self):
    ...
    def test_expose_on_async_function(self):
    ...
    def test_expose_on_method(self):
...
class TestIsExposed:
    ...
    def test_is_exposed_false(self):
    ...
    def test_is_exposed_false_for_non_callable(self):
    ...
    def test_is_exposed_false_for_wrong_attribute(self):
...
class TestGetExposeMeta:
    ...
    def test_get_expose_meta_returns_metadata(self):
    ...
    def test_get_expose_meta_returns_none(self):
    ...
    def test_get_expose_meta_returns_none_for_wrong_type(self):
