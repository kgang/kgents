...
class TestCmdNew:
    ...
    def test_create_agent_json(self, capsys):
...
class TestCmdRun:
    ...
    def test_run_intent(self, capsys):
    ...
    def test_classification_deterministic(self, capsys):
        result = cmd_run(["lint code", "--format=json", "--dry-run"])
        assert result == 0
        output = json.loads(capsys.readouterr().out)
        assert output["output"]["classification"] == "DETERMINISTIC"

    def test_classification_probabilistic(self, capsys):
...
class TestCmdCheck:
    ...
    def test_check_target(self, capsys):
    ...
    def test_check_against_laws(self, capsys):
        result = cmd_check(["test.py", "--against=laws"])
        assert result == 0

    def test_check_strict(self, capsys):
...
class TestCmdWatch:
    ...
    def test_watch_target(self, capsys):
...
class TestCmdFind:
    ...
    def test_find_query(self, capsys):
    ...
    def test_find_with_type(self, capsys):
...
class TestCmdSpeak:
    ...
    def test_speak_with_level(self, capsys):
...
class TestCmdJudge:
    ...
    def test_judge_input(self, capsys):
...
class TestRiskAssessment:
    ...
    def test_elevated_from_keywords(self):
        steps = [Step(1, "check", [], "Check", RiskLevel.SAFE)]
...
class TestPlanGeneration:
    ...
    def test_generate_check_plan(self):
    ...
    def test_plan_has_conditions(self):
...
class TestCmdDo:
    ...
    def test_composite_intent(self, capsys):
    ...
    def test_cancelled_execution(self, mock_input, capsys):
        result = cmd_do(["check test.py"])
        assert result == 0
        assert "cancelled" in capsys.readouterr().out.lower()

    @patch("builtins.input", return_value="y")
    def test_confirmed_execution(self, mock_input, capsys):
        result = cmd_do(["check test.py"])
        assert result == 0
        assert "Execution Complete" in capsys.readouterr().out

    def test_auto_yes(self, capsys):
...
class TestIntegration:
    ...
    def test_new_then_check_flow(self, capsys):
        # Create an agent
    ...
    def test_speak_then_find(self, capsys):
        # Create a tongue
    ...
    def test_intent_router_coverage(self, capsys):
