...
class TestNutrientBlock:
    ...
    def test_cardinality_query(self):
...
class TestCompostBin:
    ...
    def test_basic_composting(self):
    ...
    def test_seal_creates_block(self):
    ...
    def test_quantile_tracking(self):
    ...
    def test_aggregation_tracking(self):
    ...
    def test_reset_after_seal(self):
...
class TestFactoryFunctions:
    ...
    def test_create_nutrient_block(self):
