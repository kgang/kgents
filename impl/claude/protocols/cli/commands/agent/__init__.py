...
def print_help() -> None:
    ...
    print("  --target <type>     Projection target: k8s|cli|docker (default: k8s)")
    print("  --input <data>      Input data for 'run' command")
    print("  --stream            Enable streaming output (for 'run' command)")
    print("  --trace             Show state transitions (for 'run' command)")
