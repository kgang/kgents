...
class ChatSessionFactory:
    ...
    def _get_observer_id(self, observer: "Umwelt[Any, Any]") -> str:
        ...
        try:
            dna = observer.dna
            return getattr(dna, "name", "anonymous")
        except Exception:
            return "anonymous"
    ...
    def _build_prompt_context(
        ...
        try:
            dna = observer.dna
            ctx.observer_name = getattr(dna, "name", "user")
            ctx.observer_archetype = getattr(dna, "archetype", "guest")
        except Exception:
            pass
    ...
    async def _create_flow(self, config: ChatConfig) -> Any:
        ...
        try:
            ...
            # Create a simple echo agent stub for testing
