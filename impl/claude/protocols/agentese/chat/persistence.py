...
- ChatSessionPersistence: Save/load/list/search sessions via D-gent
...
# =============================================================================
# ChatSessionPersistence: D-gent integration
# =============================================================================
...
class MemoryInjector:
    ...
    def __init__(
        self,
        persistence: ChatSessionPersistence | None = None,
    ):
...
_persistence: ChatSessionPersistence | None = None
...
def get_persistence() -> ChatSessionPersistence:
    ...
    if _persistence is None:
        _persistence = ChatSessionPersistence()
    return _persistence
