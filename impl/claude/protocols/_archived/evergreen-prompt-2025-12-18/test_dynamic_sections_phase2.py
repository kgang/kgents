...
class TestForestSource:
    ...
    @pytest.mark.asyncio
    async def test_fetch_reads_forest_file(self, context_with_forest: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_extracts_summary(self, context_with_forest: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_extracts_active_trees(self, context_with_forest: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_limits_active_trees(self, context_with_forest: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_focus_intent_filters_trees(self, context_with_focus: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rigidity_is_soft(self, context_with_forest: CompilationContext) -> None:
...
class TestForestSectionCompiler:
    ...
    def test_compile_produces_section(self, context_with_forest: CompilationContext) -> None:
...
class TestPhaseSource:
    ...
    @pytest.mark.asyncio
    async def test_fetch_with_phase(self, context_with_phase: CompilationContext) -> None:
...
class TestGitSource:
    ...
    @pytest.mark.asyncio
    async def test_fetch_in_git_repo(self, context_with_git: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_shows_modified_files(self, context_with_git: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_shows_recent_commits(self, context_with_git: CompilationContext) -> None:
...
class TestGitBranchSource:
    ...
    @pytest.mark.asyncio
    async def test_fetch_branch_name(self, context_with_git: CompilationContext) -> None:
...
class TestContextSectionCompiler:
    ...
    def test_compile_produces_section(self, context_with_git: CompilationContext) -> None:
...
class TestGitContextSectionCompiler:
    ...
    def test_compile_produces_detailed_git(self, context_with_git: CompilationContext) -> None:
...
class TestCombinedContextSource:
    ...
    @pytest.mark.asyncio
    async def test_combines_multiple_sources(self, context_with_git: CompilationContext) -> None:
...
class TestDynamicSectionsIntegration:
    ...
    @pytest.mark.asyncio
    async def test_create_context_soft_section(self, context_with_git: CompilationContext) -> None:
...
class TestCategoryLaws:
    ...
    def test_compilation_determinism(self, context_with_forest: CompilationContext) -> None:
    ...
    @pytest.mark.asyncio
    async def test_source_ordering(self, context_with_forest: CompilationContext) -> None:
