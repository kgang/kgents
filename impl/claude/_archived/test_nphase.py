...
class TestHandles:
    ...
    def test_list_handles_by_phase(self, client: "TestClient") -> None:
        ...
        response = client.get(
            f"/v1/nphase/sessions/{session_id}/handles?phase=UNDERSTAND"
        )
        data = response.json()
        assert data["total"] == 1
...
class TestEntropy:
    ...
    def test_spend_entropy(self, client: "TestClient") -> None:
        ...
        response = client.post(
            f"/v1/nphase/sessions/{session_id}/entropy?category=llm&amount=100"
        )
    ...
    def test_spend_entropy_accumulates(self, client: "TestClient") -> None:
        ...
        response = client.post(
            f"/v1/nphase/sessions/{session_id}/entropy?category=llm&amount=50"
        )
