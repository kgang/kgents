---
path: docs/skills/n-phase-cycle/re-metabolize-slash-command
status: active
progress: 0
...
- **Ingest**: Pull `HYDRATE.md`, `spec/principles.md`, `plans/principles.md`, and all `docs/skills/n-phase-cycle/*.md`.  
